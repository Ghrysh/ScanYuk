...
<head>
    ...
    <title>Login Tamagotchi - {{ $username }}</title>
    ...
    <div class="relative z-10 w-full max-w-md">
        <div class="bg-slate-800/60 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-slate-700/50">
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-white mb-2">Welcome Back, <span class="text-teal-400">{{ $username }}</span>!</h1>
                <p class="text-slate-400 text-sm">Silakan masukkan password akun Tamagotchi Anda untuk melihat perjalanan.</p>
            </div>
            ...
            <form action="{{ route('tamagotchi.login', $username) }}" method="POST">
                @csrf
                <div class="mb-6">
