...
<section class="w-full flex flex-col items-center justify-center px-6 text-center pt-24 pb-16 md:pt-32 md:pb-24 bg-gradient-to-b from-white to-slate-50/50">
    ...
    <div class="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
        ...
        <a href="#" class="w-full sm:w-auto px-8 py-4 rounded-lg bg-white text-teal-600 border border-teal-200 font-semibold text-base hover:bg-teal-50 transition-colors flex items-center justify-center gap-2">
