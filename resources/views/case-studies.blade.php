...
<main class="bg-slate-50 min-h-screen pb-24">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-6">
        ...
        <div class="flex justify-center pt-8 pb-4">
            <a href="#" class="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-gradient-to-r from-teal-500 to-indigo-500 text-white text-sm font-bold shadow-lg shadow-indigo-200 hover:opacity-90 transition-all hover:-translate-y-0.5">
