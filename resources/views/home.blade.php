...
<div class="w-full flex flex-col items-center justify-center px-4 text-center py-32 md:py-48 relative">
    ...
    <button class="group relative px-8 py-4 rounded-lg btn-gradient text-white font-semibold text-lg shadow-xl shadow-indigo-200 hover:scale-105 transition-transform duration-200 flex items-center gap-3">
