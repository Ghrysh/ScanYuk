    ...
    <div style="position: absolute; left: -9999px; top: -9999px;">
        <div id="flyer-template" class="w-[800px] h-[1130px] flex flex-col items-center justify-between p-12 bg-slate-900 text-white relative overflow-hidden" style="font-family: 'Inter', sans-serif;">
            ...
            <div class="z-10 text-center mt-8 w-full">
                <div class="inline-flex items-center justify-center bg-teal-500/20 border border-teal-400 text-teal-400 font-bold px-8 pt-2.5 pb-3 rounded-full text-xl mb-8 tracking-widest uppercase leading-none">
                    AR Experience
                </div>
            ...
            <div class="z-10 w-full bg-slate-800/80 border border-slate-700 rounded-3xl p-8 mb-4 shadow-xl">
                ...
                <div class="space-y-6 text-xl font-medium text-slate-200">
                    <div class="flex items-start gap-5">
                        <div class="w-12 h-12 rounded-full bg-teal-500 text-white flex items-center justify-center font-bold flex-shrink-0 text-2xl pb-1" style="line-height: 1;">1</div>
                    ...
                    <div class="flex items-start gap-5">
                        <div class="w-12 h-12 rounded-full bg-teal-500 text-white flex items-center justify-center font-bold flex-shrink-0 text-2xl pb-1" style="line-height: 1;">2</div>
                    ...
                    <div class="flex items-start gap-5">
                        <div class="w-12 h-12 rounded-full bg-teal-500 text-white flex items-center justify-center font-bold flex-shrink-0 text-2xl pb-1" style="line-height: 1;">3</div>
