...
<div class="max-w-[100rem] mx-auto w-full px-4 sm:px-6 lg:px-8 py-10" x-data="{
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-6">
        ...
        <div class="bg-white p-5 rounded-xl border border-slate-200 shadow-sm relative group overflow-hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm flex flex-col hover:border-teal-300 transition-colors">
            <div class="p-6 border-b border-slate-100 flex-grow">
                ...
                <p class="text-[10px] font-bold text-slate-400 mt-4 mb-2 tracking-wide uppercase">Antrian Hari Ini</p>
            ...
            <div class="p-4 bg-slate-50 flex items-center justify-between rounded-b-xl gap-2">
                ...
                @else
                <button type="button" onclick="showAppConfirm('Layanan Kosong', 'Anda belum menambahkan layanan apapun ke lokasi ini. Silakan klik Kelola dan tambahkan setidaknya 1 layanan (misal: Poli Umum) terlebih dahulu agar QR Code bisa digunakan.', '{{ route('queue.locations.manage', $location->id) }}?add_service=1')" class="px-4 py-2 bg-white border border-slate-200 rounded-lg text-red-400 hover:text-red-600 hover:bg-red-50 transition-colors" title="Layanan Kosong">
